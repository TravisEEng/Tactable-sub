...
describe('Client', function () {
    ...
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockClient = new entities_1.TodoClient();
                    inversify_config_1.myContainer.rebind(types_1.TYPES.TodoClient).toConstantValue(new entities_1.TodoClient());
    ...
    it("mocking the client", function () {
        jest.mock('../entities/ToDoClient');
        test('testing', function () {
            var toClient = new entities_1.TodoClient();
            toClient.getInfo(1);
